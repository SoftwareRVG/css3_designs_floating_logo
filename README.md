...
<html lang="en">
  <head>
    ...
    <meta name="dcterms.created" content="vi., 15 abr. 2016 16:36:39 GMT">
    <meta name="description" content=" ADVANCED DESIGNS ,CSS ANIMATION FLOATING LOGO by SOFTWARE RVG">
    <meta name="keywords" content="ADVANCED DESIGNS,CSS ANIMATION,FLOATING LOGO,BY SOFTWARE RVG, PROGRAMMER,DESIGNER & DEVELOPER">
    <title>CSS3 ANIMATION FLOATING LOGO by SOFTWARE RVG</title>
...
.layer {
  ...
  transform-style: preserve-3d;
  opacity: 0;
  animation: ?_? 5s infinite alternate ease-in-out -7.5s, o_O 0.1s 1;
